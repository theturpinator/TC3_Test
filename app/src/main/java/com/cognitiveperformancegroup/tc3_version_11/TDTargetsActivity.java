...
public class TDTargetsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tdtarget);
                ...
                nextButton.setOnClickListener(new View.OnClickListener() {
                                                  ...
                                                  public void onClick(View v) {
                                                      ...
                                                      if (row < numRows-1) {
                                                          ...
                                                          AlertDialog.Builder instructions = new AlertDialog.Builder(TDTargetsActivity.this, R.style.TC3AlertDialog);
                                                          final TextView instructionsText = new TextView(TDTargetsActivity.this);
