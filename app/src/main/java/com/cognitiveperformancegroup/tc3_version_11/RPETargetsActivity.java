...
public class RPETargetsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rpetargets);
                        ...
                        new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (checkButtons[index].getBackground().getConstantState() == getDrawable(R.drawable.observed_checkmark_green).getConstantState()) {
                                    ...
                                    commentsInput.setGravity(Gravity.START);
                ...
                nextButton.setOnClickListener(new View.OnClickListener() {
                                                  ...
                                                  public void onClick(View v) {
                                                      ...
                                                      if (row < numRows-1) {
                                                          //go to next row
                                                          row++;
                                                          openRPE(sheetNum, row);
                                                      } else {

                                                          AlertDialog.Builder instructions = new AlertDialog.Builder(RPETargetsActivity.this, R.style.TC3AlertDialog);
                                                          final TextView instructionsText = new TextView(RPETargetsActivity.this);
